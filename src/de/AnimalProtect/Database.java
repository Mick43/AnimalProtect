...
public class Database {
	...
	*/
	...
	/**
	 * Leert alle Eintr�ge im Arbeitsspeicher.
	 */
	public void clear() {
		this.entities.clear();
		this.keys.clear();
	...
	/**
	 * F�gt einen Spieler der Spielerliste hinzu, falls er beim Start noch nicht geladen wurde.
	...
	/**
	 * F�gt ein Tier der Datenbank hinzu, oder aktualisiert seine Werte.
	...
	/**
	 * Entsichert ein Tier und l�scht es aus der Datenbank
	...
	/**
	 * Gibt das Animal mit der angegeben UniqueId zur�ck.
	...
	/**
	 * Gibt alle Tiere, die dem Spieler mit der angegeben Id geh�ren wieder
	...
	/**
	 * Gibt alle fehlgeschlagenen Queries zur�ck.
	...
	/**
	 * Pr�ft, ob die Datenbank-Verbindung aktiv ist.
