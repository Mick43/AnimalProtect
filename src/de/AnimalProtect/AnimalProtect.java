...
public class AnimalProtect extends JavaPlugin {
	...
	/**
	 * L�dt die komplette Datenbank von AnimalProtect neu in den RAM.
	 */
	...
	/**
	 * Gibt aus, ob das �bergebene Entity ein Tier ist, welches man mit AnimalProtect sichern kann.
	 * @param entity - Das Entity welches �berpr�ft wird.
	...
	/**
	 * Gibt das Entity zur�ck, welches von dem Spieler ausgew�hlt wurde.
	 * @param uuid - Die UniqueID des Spielers.
	 * @return Das Entity, welches ausgew�hlt wurde, oder null, falls keins ausgew�hlt wurde.
	 */
